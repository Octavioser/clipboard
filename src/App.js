...
import { parsingClipboard, parsingDataSetClipboard, parsingImgSetClipboard } from './Utils'
        ...
        <div className='panel'>
            ...
            <div className='main-area'>
                ...
                <div className='item-area'>
                    ...
                    {btnList.map((e, i) => {
                        if (e.type === 'html') {
                            return <Item
                                ...
                                label={e.labelText}
                                copyItem={e.value}
                                parsingDataSetClipboard={parsingDataSetClipboard}
                            />
                        }
                    ...
                    {btnList.length / 2 > 0 && <div className='item-panel' style={{ opacity: 0 }} />}
                </div>
